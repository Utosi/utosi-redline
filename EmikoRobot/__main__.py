...
PM_START_TEXT = """
*Hello {} !*
✪ I'm an anime-theme management bot [✨](https://telegra.ph/file/8fa31785d444aec59f484.jpg)
────────────────────────
× *Uptime:* `{}`
× `{}` *users, across* `{}` *chats.*
────────────────────────
...
buttons = [
    [
        InlineKeyboardButton(text="About ᴢᴇʙᴏ ʀᴏʙᴏᴛ", callback_data="emiko_"),
    ],
    [
    ...
    [
        InlineKeyboardButton(
            text="➗ Add ᴢᴇʙᴏ ʀᴏʙᴏᴛ To Your Group ➗", url=f"t.me/{bu}?startgroup=new"),
    ],
]
    ...
    if query.data == "emiko_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 ...
                 [
                    InlineKeyboardButton(text="Source Code", url="https://github.com/kykoubot/Zeborobot"),
                 ],
                 [
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Support", url="t.me/Dbzea"),
                    InlineKeyboardButton(text="Updates", url="https://t.me/Storezeastore"),
                 ],
                 [
                    InlineKeyboardButton(text="Go Back", callback_data="emiko_"),
